...
export default function DashboardClient({
  ...
  const [activeTab, setActiveTab] = useState<
    "all" | "in_progress" | "completed" | "workshops"
  >("all");
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
        <div className="absolute top-0 right-0 -mr-20 -mt-20 h-80 w-80 rounded-full bg-lime-200 blur-3xl pointer-events-none opacity-35" />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 pb-4">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 bg-white pl-10 pr-4 py-2 text-xs text-gray-800 placeholder-gray-400 focus:border-lime-400 focus:ring-2 focus:ring-lime-100 focus:outline-none shadow-sm"
          />
        </div>
      </div>
          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl border-2 border-lime-300 bg-white p-8 shadow-2xl text-gray-900">
            ...
            <div className="py-8 text-center space-y-4">
              ...
              <p className="text-xs text-gray-500 max-w-md mx-auto">
                a complété avec succès 100% du cursus d&apos;apprentissage
                intensif et validé l&apos;ensemble des modules pratiques de :
              </p>
              <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 max-w-lg mx-auto">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {certificateCourse.domain || "Technologie & Design"} ·{" "}
                  {certificateCourse.totalLessons} leçons validées
                </p>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 pt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs text-gray-400">
              <div>
                <p className="font-mono text-[11px] text-gray-600">
                  ...
                  {certificateCourse.id.substring(0, 8).toUpperCase()}-
