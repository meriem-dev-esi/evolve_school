        ...
        <main className="flex-1 px-6 pt-32 pb-20 relative overflow-hidden flex items-center justify-center">
          ...
          <div className="relative z-10 mx-auto max-w-xl text-center">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-gray-500">
              ...
              êtes arrêté, suivez votre assiduité et téléchargez vos
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl border border-gray-200 bg-white px-6 py-3.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-lime-300 transition shadow-sm"
              >
