...
export default function LockedCourseCard({ locale }: Props) {
  return (
    <article className="group relative w-[290px] min-w-[290px] shrink-0 overflow-hidden rounded-3xl border border-white/10 bg-zinc-900/40 backdrop-blur-xl transition-all duration-300 hover:border-brand/40 hover:-translate-y-1">
      ...
      <div className="pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-brand/10 blur-2xl transition-opacity duration-300 group-hover:opacity-100 opacity-40" />
      ...
      <Link href={`/${locale}/sign-in`} className="block">
        ...
        <div className="p-5">
          ...
          <p className="mt-2 text-xs leading-relaxed text-white/50">
            Connectez-vous pour accéder à vos recommandations, votre progression et vos cours sauvegardés.
          </p>
